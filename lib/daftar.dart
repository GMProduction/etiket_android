...
//                                    controller: tecNumber,
                ...
                validator: (val) {
                  if (val != password) {
                    return "Belum sesuai dengan password yang di masukan";
                  } else {
                    return null;
                  }
                },
  ...
  void daftar(nama, alamat, no_hp, username, pass, konfpassword) async {
    ...
    dynamic data;
    data = await req.postApi("register", {"username": username, "password": pass, "name": nama, "alamat": alamat, "no_hp": no_hp, "password_confirmation": konfpassword, "role" : "user"});
